            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="licencia" required maxlength="20" value="{{$medicos->licencia}}">
                    </div>
                          ...
                          <label for="especialidad_id" class="form-label">Especialidad</label>
                              <select name="especialidad_id" id="especialidad_id" class="form-control">
                                  ...
                                  @foreach ($especialidades as $especialidad)
                                        <option value="{{ $especialidad->id }}" {{ $medicos->especialidad_id == $especialidad->id ? 'selected' : '' }}>
                                              {{ $especialidad->nombre }}
                                       </option>
                                 @endforeach
                            </select>
